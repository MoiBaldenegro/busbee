...
const mockTravel:Travel = Travel.create({id:"0123", origin:"centro",destination:"Union",passengerCount:24})
export class MockRepository implements TravelRepository {
    ...
    async create(travel: Partial<Travel>): Promise<TravelResponse|Error> {
        ...
        return {message:"viaje creado exitosamente",succes:true,travel:newTravel}
